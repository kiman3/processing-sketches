...
public class warpgrid extends PApplet {

// Borrowed from https://www.openprocessing.org/sketch/7362#
...
public static int MAX_GRID_WIDTH = 64;
	 ...
	 * @return lerp in 2D
	 */
	public float interpolate(float topLeft, float topRight, float bottomLeft,
	 ...
	 */
	public int getColor(VectorType subPixelPosition) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#050000", "--hide-stop", "warpgrid" };
    if (passedArgs != null) {
